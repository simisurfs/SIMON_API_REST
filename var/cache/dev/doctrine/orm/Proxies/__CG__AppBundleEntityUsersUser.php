 ...
 */
class UsersUser extends \AppBundle\Entity\UsersUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\UsersUser' . "\0" . 'username', '' . "\0" . 'AppBundle\\Entity\\UsersUser' . "\0" . 'usernameCanonical', '' . "\0" . 'AppBundle\\Entity\\UsersUser' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\UsersUser' . "\0" . 'emailCanonical', '' . "\0" . 'AppBundle\\Entity\\UsersUser' . "\0" . 'enabled', '' . "\0" . 'AppBundle\\Entity\\UsersUser' . "\0" . 'salt', '' . "\0" . 'AppBundle\\Entity\\UsersUser' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\UsersUser' . "\0" . 'last_login', '' . "\0" . 'AppBundle\\Entity\\UsersUser' . "\0" . 'confirmationToken', '' . "\0" . 'AppBundle\\Entity\\UsersUser' . "\0" . 'passwordRequestedAt', '' . "\0" . 'AppBundle\\Entity\\UsersUser' . "\0" . 'roles', '' . "\0" . 'AppBundle\\Entity\\UsersUser' . "\0" . 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UsersUser $proxy) {
