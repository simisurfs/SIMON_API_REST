 ...
 */
class UsersClient extends \AppBundle\Entity\UsersClient implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\UsersClient' . "\0" . 'randomId', '' . "\0" . 'AppBundle\\Entity\\UsersClient' . "\0" . 'redirectUris', '' . "\0" . 'AppBundle\\Entity\\UsersClient' . "\0" . 'secret', '' . "\0" . 'AppBundle\\Entity\\UsersClient' . "\0" . 'allowedGrantTypes', '' . "\0" . 'AppBundle\\Entity\\UsersClient' . "\0" . 'id'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UsersClient $proxy) {
